          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-start gap-8 md:grid-cols-3 md:gap-12">
              <div className="flex flex-col items-center text-center gap-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">1. Discover Assets</h3>
                    <p className="text-muted-foreground">
                      Solar projects and energy credits are vetted and tokenized on the blockchain for you to browse.
                    </p>
                  </div>
              </div>
               <div className="flex flex-col items-center text-center gap-4">
                   ...
                   <div className="space-y-2">
                    <h3 className="text-xl font-bold">2. Trade on the Marketplace</h3>
                    <p className="text-muted-foreground">
                      Buy and sell project tokens and energy credits on our transparent and secure peer-to-peer marketplace.
                    </p>
                   </div>
              </div>
              <div className="flex flex-col items-center text-center gap-4">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-bold">3. Track Your Impact</h3>
                    <p className="text-muted-foreground">
                      Use our dashboard and AI insights to monitor your portfolio's financial performance and environmental impact.
                    </p>
                  </div>
              </div>
            </div>
