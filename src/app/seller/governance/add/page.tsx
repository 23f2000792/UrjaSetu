  ...
  return (
    <div className="space-y-8 max-w-2xl mx-auto">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold tracking-tight text-primary">Create a New Proposal</h1>
        <p className="text-muted-foreground mt-2">
          Propose changes to shape the future of the UrjaSetu platform.
        </p>
      </div>
